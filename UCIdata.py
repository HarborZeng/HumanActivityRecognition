...
def read_data(file_path):
    column_names = ['acc-chest-X', 'acc-chest-Y', 'acc-chest-Z',
                    'ele-lead1', 'ele-lead2',
                    'acc-left-ankle-X', 'acc-left-ankle-Y', 'acc-left-ankle-Z',
                    'gyro-left-ankle-X', 'gyro-left-ankle-Y', 'gyro-left-ankle-Z',
                    'mag-left-ankle-X', 'mag-left-ankle-Y', 'mag-left-ankle--Z',
                    'acc-right-lower-arm-X', 'acc-right-lower-arm-Y', 'acc-right-lower-arm-Z',
                    'gyro-right-lower-arm-X', 'gyro-right-lower-arm-Y', 'gyro-right-lower-arm-Z',
                    'mag-right-lower-arm-X', 'mag-right-lower-arm-Y', 'mag-right-lower-arm-Z',
                    'label'
                    ]
...
def segment_signal(data, window_size=90):
    ...
    count = 0
    for (start, end) in windows(dataset['acc-right-lower-arm-X'], window_size):
        count += 1
        x = data["acc-right-lower-arm-X"][int(start):int(end)]
        y = data["acc-right-lower-arm-Y"][int(start):int(end)]
        z = data["acc-right-lower-arm-Z"][int(start):int(end)]
        if len(dataset['acc-right-lower-arm-X'][int(start):int(end)]) == window_size:
            segments = np.vstack([segments, np.dstack([x, y, z])])
            labels = np.append(labels, stats.mode(data["label"][int(start):int(end)])[0][0])
...
def plot_activity(activity, data):
    ...
    plot_axis(ax0, data['acc-right-lower-arm-X'], 'x-axis')
    plot_axis(ax1, data['acc-right-lower-arm-Y'], 'y-axis')
    plot_axis(ax2, data['acc-right-lower-arm-Z'], 'z-axis')
...
dataset = read_data('healthData.log')
dataset['acc-right-lower-arm-X'] = feature_normalize(dataset['acc-right-lower-arm-X'])
dataset['acc-right-lower-arm-Y'] = feature_normalize(dataset['acc-right-lower-arm-Y'])
dataset['acc-right-lower-arm-Z'] = feature_normalize(dataset['acc-right-lower-arm-Z'])
# print(dataset)
